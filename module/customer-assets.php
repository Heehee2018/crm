...
function initAssetsData() {
  ...
  $html["json"]["assets"] = json_encode($html["m"]["assets"]);
  //print_r($html["json"]["assets"]);exit;
  // 工作信息 end
}
?>